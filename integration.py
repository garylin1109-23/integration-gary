...
def print_student():
    ...
    def create_student():
        ...
        cusor.execute('insert into db_student(db_student_id, db_student_name) values(?,?)',(student_id, student_name))
    ...
    def overview_student():
        cusor.excute('select * from db_student')
        records =cursor.fetchall()
        print (records)

    button_overview = tk.Button(root, text='Overview', coomand=overview_student)
